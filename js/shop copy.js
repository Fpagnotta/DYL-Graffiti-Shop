// Costructor de productos + creacion  :
...
function totalAPagar (){
        ...
        $(".finalizarCompra").append(`<div class="seleccionados">
                                      ...
                                      <h3>Necesitas la cotizacion en dolar?<button class="cotizacion btn btn-primary">CLICK AQUI</button><h3>
                                    ...
                                    $(".cotizacion").on("click",cotizarEnDolares)
                                    function cotizarEnDolares (){
                                        $.ajax({
                                            type :"GET",
                                            url:"https://www.dolarsi.com/api/api.php?type=valoresprincipales",
                                            datatype: "JSON",
                                              success: function cotizar (){
                                                  [0].casa.comienzoDeCompra
                                              }
...
$("document").ready ( function (){
    ...
    /** Creacion de galerias + push de productos  */
